 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class backup_zoomoodle_activity_structure_step extends backup_activity_structure_step {
...
/*        
        ...
        $zoomoodle = new backup_nested_element('zoomoodle', array('id'), array(
        ...
        // Define data sources.
        $zoomoodle->set_source_table('zoomoodle', array('id' => backup::VAR_ACTIVITYID));
        ...
        $zoomoodle->annotate_files('mod_zoomoodle', 'intro', null);

        // Return the root element (zoom), wrapped into standard activity structure.
        return $this->prepare_activity_structure($zoomoodle);
*/
    }
}