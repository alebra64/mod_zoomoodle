...
$string['meeting_error'] = 'Errore nel recupero dei dettagli del meeting. Riprova più tardi o contatta il supporto se il problema persiste.';
$string['meeting_time'] = 'Orario del meeting';
$string['minutes'] = 'minuti';
$string['join_meeting'] = 'Partecipa al meeting';
$string['attendance_stats'] = 'Statistiche di presenza';
$string['participant'] = 'Partecipante';
$string['status'] = 'Stato';
$string['present'] = 'Presente';
$string['absent'] = 'Assente';
$string['meeting_not_found'] = 'Meeting non trovato o non più disponibile';
$string['meeting_access_error'] = "Errore nell'accesso al meetin";
$string['no_join_url'] = 'URL di accesso non disponibile';
$string['meeting_expired'] = 'Questo meeting è scaduto';
$string['not_registered'] = 'Non sei registrato per questo meeting';
$string['registration_pending'] = 'La tua registrazione è in attesa di approvazione';
$string['meeting_full'] = 'Questo meeting è al completo';
$string['join_before_start'] = 'Questo meeting non è ancora iniziato';
$string['join_after_end'] = 'Questo meeting è già terminato';
